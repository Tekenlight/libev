...
ACLOCAL = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/missing autoconf
AUTOHEADER = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/missing autoheader
AUTOMAKE = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/missing automake-1.14
AWK = awk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 4.22
abs_builddir = /Volumes/NEW_DISK/user/sudheerp/lcha
abs_srcdir = /Volumes/NEW_DISK/user/sudheerp/lcha
abs_top_builddir = /Volumes/NEW_DISK/user/sudheerp/lcha
abs_top_srcdir = /Volumes/NEW_DISK/user/sudheerp/lcha
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/lcha/install-sh
