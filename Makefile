...
ACLOCAL = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/missing autoconf
AUTOHEADER = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/missing autoheader
AUTOMAKE = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/missing automake-1.14
AWK = awk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 4.22
abs_builddir = /Volumes/NEW_DISK/user/sudheerp/libev
abs_srcdir = /Volumes/NEW_DISK/user/sudheerp/libev
abs_top_builddir = /Volumes/NEW_DISK/user/sudheerp/libev
abs_top_srcdir = /Volumes/NEW_DISK/user/sudheerp/libev
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Volumes/NEW_DISK/user/sudheerp/libev/install-sh
